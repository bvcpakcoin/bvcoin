...
abstract contract Context {
    function _msgSender() internal view virtual returns (address) {
        ...
        return msg.data
/ OpenZeppelin Contracts v4.4.1 (access/bvcpak.sol)
/**
...
contract BEP20 is Ownable, IBEP20 {
     ...
     */
    function decimals(18) public view virtual override returns (uint8) {
        return _decimals;
    }
 ...
 * @dev Implementation of the BEP20
 */
contract is BEP20, ServicePayer, GeneratorCopyright {
    constructor( owner
        string memory name_,
